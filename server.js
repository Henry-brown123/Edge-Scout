...
// TEMPORARY diagnostic endpoint — Serie A negative-ROI investigation (Action 3).
// Uses the real, currently-live pipeline exactly as Priority 1 fixed it: GBDT
// model.predict() -> applyLeagueBiasCorrection() (homeAdvBaseWeight still inert).
app.get('/api/debug/ev-league-outcome-split', (req, res) => {
  try {
