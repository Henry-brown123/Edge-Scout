...
// TEMPORARY diagnostic endpoint — real-pipeline homeAdvBaseWeight sweep, post Priority 2.
// Uses the exact live mechanism: GBDT model.predict() -> applyLeagueBiasCorrection()
// with homeAdvBaseWeight overridden for the tested league only.
